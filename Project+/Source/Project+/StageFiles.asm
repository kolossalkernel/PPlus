...
0x10, | # Spear Pillar
0x0F, | # Saffron City
0x3D, | # Brinstar Depths
0x3E, | # Mushroom Kingdom 2
0x3F, | # Mushroom Kingdom 1
0x40, | # Great Bay
0x41, | # Kongo Jungle Melee 64
0x42, | # Yoshi's Island Melee 64
0x43, | # Pokemon Stadium 1
0x44, | # Princess Peach's Castle
0x45, | # Venom
0x46, | # Icicle Mountain
0x47, | # Kongo Jungle
0x48, | # Mute City
0x49  | # Trophy Collector
...
half[74] |	# Stage Count + 2
| # OLD SLOTS
0x0808, 0x1612, 0x0303, 0x373C, | # Rumble Falls, Port Town Aero Dive, Delfino's Secret, Green Greens
0x0505, 0x0606, 0x2A33, 0x3038, | # Metal Cavern, Bowser's Castle, Yoshi's Story, Corneria
0x5D4B, 0x4124, 0x492C, 0x0C0C, | # Trophy Collector, Mario Circuit, Metroid Lab, Frigate Orpheon
0x0D0D, 0x0E0E, 0x130F, 0x2C35, | # Yoshi's Island, Halberd, Lylat Cruise, Onett
0x323A, 0x5B49, 0x5A48, 0x5442, | # Brinstar, Kongo Jungle, Icicle Mountain, Great Bay
0x1915, 0x1C16, 0x1D17, 0x1E18, | # Castle Siege, Wario Land, Distant Planet, Skyworld
0x221C, 0x1F19, 0x211B, 0x4528, | # Shadow Moses Island, Fountain of Dreams, Smashville, Dinosaur Land
0x231D, 0x241E, 0x4629, 0x2932, | # Green Hill Zone, PictoChat, Oil Drum Alley, Temple
0x0404, 0x472A, 0x251F, 0x1814, | # Luigi's Mansion, Golden Temple, Hanenbow, Flat Zone 2
0x1713, 0x4F3D, 0x5947, 0x2B34, | # Infinite Glacier, Rainbow Cruise, Princess Peach's Castle, Jungle Japes
0x2E3B, 0xFF64, 0xFF64, 0x5846, | # Pokemon Stadium 2, NOTHING, NOTHING, Venom
| # NEW SLOTS
0x4023, 0x330A, 0x4225, 0x0909, | # Dracula's Castle, Hyrule Castle, Clock Town, Pirate Ship
0x4427, 0x0707, 0x4326, 0x4B2E, | # Dead Line, Kongo Jungle 64, Sky Sanctuary, Venus Lighthouse
0x482B, 0x0B0B, 0x4A2D, 0x1511, | # Bell Tower, Norfair, Cookie Country, Spear Pillar
0x4C2F, 0x4D30, 0x4E31, 0x2F37, | # Mushroom Kingdom, WarioWare, Subspace, Peach's Castle
0x1410, 0x5C4A, 0x5745, 0x5341, | # Saffron City, Mute City, Pokemon Stadium 1, Mushroom Kingdom 1
0x513F, 0x201A, 0x3139, 0x503E, | # Brinstar Depths, Fourside, Big Blue, Poke Floats
0x5240, 0x0101, 0x0202, 0x2D36, | # Mushroom Kingdom 2, Battlefield, Final Destination, Dream Land
0x5644, 0x5543                  | # Yoshi's Island Melee 64, Kongo Jungle Melee 64
...
byte 12 @ $80496002 # Page 3
byte 00 @ $80496003 # Page 4 (Unused)
byte 00 @ $80496004 # Page 5 (Unused)
byte 72 @ $800AF673 # Stage Count
