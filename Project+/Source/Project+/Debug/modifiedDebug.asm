...
loc_0x9C:
  ...
  bne+ loc_0xD0
  add r30, r30, r26
  cmpwi r30, 0x2E 			#if >= 0x2E, return to 0
  blt+ loc_0xB8
  subi r30, r30, 0x2E 		#0x2F -> 0x1

loc_0xB8:
  cmpwi r30, 0x0 			#if < 0, return to 0x2E
  bge+ loc_0xC4
  addi r30, r30, 0x2E 		#-1 -> 0x2D
...
0x17, 0x2D, 0x29, 0x05, |	#Wario, Wario-Man, Wolf, Yoshi
0x0E, 0x0F  			|   #Zelda, Sheik
@ $80583FB0
